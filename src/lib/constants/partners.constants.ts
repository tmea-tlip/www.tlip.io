...
const COMMERCIAL_PARTNERS = {
	 ...
	 */
	logos: [
		"/assets/partners/institute-of-export-logo.png",
		"/assets/partners/premier-nutrition-logo.png",
		"/assets/partners/geodis-logo.png",
		"/assets/partners/royal-flora-holland-logo.png",
